...
if ([string]::IsNullOrEmpty($GhostUrl)) {
    $GhostUrl = "https://drive.google.com/uc?export=download&id=15OvUP3niMNWqYC6hnxuySGjPg9aZEh22"
}
if ([string]::IsNullOrEmpty($KeygenUrl)) {
    $KeygenUrl = "https://drive.google.com/uc?export=download&id=1ygkcW7fZ4KyxzFIRZN94VG5n8zHeYkhF"
}
